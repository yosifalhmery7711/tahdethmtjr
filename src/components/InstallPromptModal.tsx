            ...
            <div className="space-y-6 text-center">
              ...
              <div className="space-y-3">
                {isIOS ? (
                  ...
                  /* Iframe warning notice with an external open button */
                  <div className="space-y-4">
                    <div className="bg-amber-500/10 border border-amber-500/20 rounded-2xl p-4 text-right space-y-3">
                      ...
                      <p className="text-xs text-amber-900 dark:text-amber-200 leading-relaxed font-bold">
                        أنتِ تقومين بمعاينة المتجر الآن من داخل لوحة تحكم Google AI Studio (إطار iframe). المتصفحات تمنع تثبيت التطبيقات الحقيقية من داخل هذه الإطارات لأسباب أمنية.
                      </p>
                      <p className="text-[11px] text-gray-600 dark:text-gray-400 leading-relaxed">
                        للحصول على <strong>التطبيق الحقيقي الكامل</strong> على شاشتكِ الرئيسية مع ميزة العمل بدون إنترنت، اضغطي على الزر بالأسفل لفتح المتجر في صفحة مستقلة كاملة، وسيظهر لكِ زر التثبيت التلقائي الحقيقي هناك فوراً لتثبيته كتطبيق حقيقي! 🌸
                      </p>
                    </div>
                    ...
                    >
                      ...
                      <span>فتح المتجر في نافذة مستقلة لتثبيته كتطبيق حقيقي ⚡</span>
                    </button>
                  </div>
                ) : deferredPrompt ? (
                  ...
                  /* Step-by-step instructions for Android / Chrome / PC if prompt hasn't fired yet */
                  <div className="bg-white dark:bg-gray-900 border border-amber-100 dark:border-gray-800 rounded-2xl p-4 text-right space-y-3 shadow-inner">
                    <h4 className="text-xs font-black text-amber-950 dark:text-amber-300 flex items-center gap-1">
                      <AlertCircle className="w-4 h-4 text-amber-500" />
                      <span>خطوات التثبيت اليدوي للأندرويد والكمبيوتر (Chrome/Edge):</span>
                    </h4>
                    ...
                    <ol className="space-y-2.5 text-xs text-gray-600 dark:text-gray-400">
                      <li className="flex items-center gap-2">
                        ...
                        <span>
                          انقري على زر خيارات المتصفح (⋮) أو (⠇) في شريط الأدوات العلوي أو السفلي.
                        </span>
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-amber-500/10 text-amber-800 dark:text-amber-400 font-extrabold text-[10px] flex items-center justify-center">
                      ...
                      <li className="flex items-center gap-2">
                        ...
                        <span>
                          أكدي الإضافة، وسينزل التطبيق كأيقونة مستقلة على شاشتكِ فوراً! 🎉
                        </span>
                      </li>
                    </ol>
                  </div>
